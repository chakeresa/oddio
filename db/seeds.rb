...
Recording.create(title: '"Don Giovanni"',
                 ...
                 user: user_1,
                 landmark: Landmark.where(name: "Ellie Caulkins Opera House at Denver Performing Arts Complex"))
Recording.create(title: "I hate my job",
                 url: "https://oddio1903.s3.us-east-2.amazonaws.com/7b66a05063f0ec4bb3f509875943b118.mp3",
                 user: user_2,
                 landmark: Landmark.where(name: "Downtown Art Gallery and Axe Room"))
...
Recording.create(title: "Tattooed Lemons???",
                 ...
                 user: user_5,
                 landmark: Landmark.where(name: "Museum of Contemporary Art Denver"))
